...
export default function ShopHero({ productCount, categoryCount }: ShopHeroProps) {
  return (
    <section className="relative border-b border-white/[0.06] bg-black">
      <div className="relative mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 sm:flex-row sm:items-end sm:justify-between sm:px-6 sm:py-10">
        <div>
          <p className="text-[12px] font-medium tracking-[0.18em] text-white/55">SHOP</p>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className={cn("rounded-xl px-4 py-2.5", "border border-white/[0.08] bg-black")}>
          ...
          >
            ...
            <span className="text-[12px] font-medium text-white">100+ Point Tested</span>
          </div>
        </div>
      </div>
    </section>
