...
export default function ContactLocationMap({ className }: ContactLocationMapProps) {
  return (
    ...
    >
      <div
        className={cn(
          "relative min-h-0 flex-1 overflow-hidden bg-[#0a0a0a]",
          "outline-none ring-0",
        )}
      >
        <iframe
      ...
      <div className="relative shrink-0 border-t border-white/10 bg-[#0a0a0a] p-4">
        ...
        <a
          ...
          className={cn(
            ...
            "outline-none focus-visible:ring-2 focus-visible:ring-[#39ff88]/30",
          )}
        >
          <Navigation className="h-4 w-4 text-[#39ff88]/90" />
          Get directions
        </a>
      </div>
    </div>
